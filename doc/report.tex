...
\begin{multicols*}{2}
	...
	where objects are not static, and their movement must be accounted for.
	The many complexities that tracking introduces require sophisticated measures in
	order to maintain accuracy, adding constraints to the motion and/or appearance of
	objects is one way to do this \citep{yilmaz2006object}.
