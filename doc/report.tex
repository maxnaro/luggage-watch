...
\begin{multicols*}{2}
	...
	\begin{center}
		...
		\begin{tabularx}{\columnwidth}
			...
			\addlinespace
			\textbf{YOLO11}  & C3k2 block; C2PSA (Cross Stage Partial with Spatial
	...
	combines a fine-tuned YOLO11-s object detector with a novel algorithm for
	...
	The authors compare YOLOv8, YOLO11, and DETR transformer models, finding that
	YOLO models significantly outperform DETR for this task --- achieving mAP@0.5
	scores of over 88\% compared to DETR's 48\%. The fine-tuned YOLO11-s model was
	...
	\label{sec:tensorrt_optimisations}
	...
	variants (YOLOv8n, YOLO11s) are typically preferred due to their reduced
	...
	their suitability for edge deployment. Ultralytics' themselves claim that
	YOLO26 is a leap forward compared to older models as seen in their own
	benchmarks (figure~\ref{fig:ultralytics_benchmarks}), but these claims will be
	...
	% TODO: this is very subject to change, depending on how successful a DeepStream implementation is

	YOLO11 and YOLO26 will be integrated using the BoT-SORT tracking algorithm
	...
	DeepStream has native support for DeepSORT through NvDCF, but BoT-SORT's
	additional complexity may require custom integration.

	\subsection{Determining Suspicious Luggage: Spatial and Temporal Logic}

	Suspicious luggage detection is spatio-temporal issue, requiring the system to
	recognise the spatial relationship between luggage and its owner, and to track
	how this relationship changes over time. The design of the abandonment logic is
	therefore critical to the system's effectiveness. The following design
	...
	\subsubsection{Association Logic and Pseudo-code}
	...
	\subsubsection{Primary Inference (Object Detection)}

	\subsubsection{Object Tracking}

	\subsubsection{Abandonment Logic and Alert Generation}

	\subsubsection{Visualisation and Output}
