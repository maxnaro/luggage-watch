...
\begin{multicols*}{2}
	...
	\begin{itemize}
		...
		\item \textbf{Temporal Thresholds:} Defining configurable parameters such as
	...
	\begin{figure*}[!htb]
		...
		\caption{Ultralytics' benchmarks comparing pre-trained YOLO26, YOLO11, and older models \citep{vina2026yolo26}.}
		\label{fig:ultralytics_benchmarks}
	\end{figure*}

	\subsection{Tracking Algorithm}

	Whilst other implementations have used the ByteTrack algorithm for tracking,
