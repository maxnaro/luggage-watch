...
\begin{itemize}
	...
	\item \textbf{Neck:} progression from the single $S\times S$ grid in
	      ...
	      in YOLOv3, to the PAN-style (Path Aggregation Network) necks used in
	      YOLOv5 onwards --- with YOLO11 additionally adding the \texttt{C2PSA}
	      spatial-attention block on top of the FPN/PAN hierarchy.
