...
\begin{multicols*}{2}
	...
	The development environment has been set up, with baseline YOLO models being
	...
	challenging, especially in the lead-up to coursework deadline and examinations.
